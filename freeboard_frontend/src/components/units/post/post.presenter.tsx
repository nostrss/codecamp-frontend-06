...
(영등포동5가, 영등포시장역) 영등포 타임스퀘어 2층'
        ...
        <PostBody>
          ...
          <PostBodySection>
            <PostBodyText>{props.data?.fetchBoard.contents}</PostBodyText>
          </PostBodySection>
        </PostBody>
        <PostFooter>
          <PostLikes>
                ...
                <RowSpaceBetween>
                  <ColumnItems>
                    ...
                    <UserComments>
                      ...
                      Pellentesque vestibulum placerat sapien quis iaculis.
                      Donec luctus commodo rutrum. Pellentesque eget ipsum
                      pulvinar, congue neque sed
                    </UserComments>
                    <UserCommentsDate>2022.03.20</UserCommentsDate>
                  </ColumnItems>
                  <RowItems>
                    <IconBox>
